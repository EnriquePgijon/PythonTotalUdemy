...
def codificar(imagenes):
    ...
    for imagen in imagenes:
        ...
        #Codificar
        codificado=fr.face_encondings(imagen)[0]
        #agregar a la lista
...
#Hay que crear un csv para que se escriba el nombre del registrado
...
if not exito:
    print("No se ha podido hacer la foto")
else:
    #reconocer cara en la foto
