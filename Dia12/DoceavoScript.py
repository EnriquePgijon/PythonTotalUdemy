#PROGRAMAR UN GESTOR DE RESTAURANTES
...
#Lista de productos
lista_comidas=["pollo","cordero","salmon","merluza","kebab","pizza","pasta","jamon"]
lista_bebidas=["agua","refresco","zumo","vino","cerveza","vodka","ron","nestea"]
lista_postres=["helado","fruta","flan","brownies","mousse","pastel","tarta","queso"]
...
etiqueta_costo_postres= Label(panel_costos,text="Costo postres",
                             font=("Dosis",12,"bold"),
                             bg="azure4",
                             fg="white",)
